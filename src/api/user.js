      ...
      security
        ...
        .then(() => {
          db.user
            ...
            .then((user) => {
              if (!user) {
                emit.reject('user.updatePassword', client, '500', 'user not found');
              }
  ...
  security
    ...
    .then(() => {
      db.user
        ...
        .then((user) => {
          if (!user) {
            return emit.reject('user.updateLogin', client, '404', 'user not found');
          }
          user
  ...
  security
    ...
    .then(() => {
      db.user
        ...
        .then((user) => {
          if (!user) {
            return emit.reject('user.updateEmail', client, '404', 'user not found');
          }
          user
